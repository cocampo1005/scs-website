...
export default function Projects() {
  ...
  return (
    <>
      <SEO
        ...
        description="Behind the builds. Explore selected projects and case studies that blend clean UX, solid engineering, and measurable results."
        path="/projects"
      ...
      >
        <JsonLd
          data={{
            ...
            url: "https://solidcodesolutionsllc.com/projects",
          }}
        />
        {/* ItemList built from CASE_STUDIES */}
        <JsonLd
          data={{
            "@context": "https://schema.org",
            "@type": "ItemList",
            itemListElement: (CASE_STUDIES || []).map((c, i) => ({
              "@type": "ListItem",
              position: i + 1,
              url: "https://solidcodesolutionsllc.com/projects#featured",
              name: c.title,
            })),
          }}
        />
          ...
          data={{
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "Projects",
                item: "https://solidcodesolutionsllc.com/projects",
              },
            ],
          }}
        />
  ...
  <GlowCard className="p-4">
    <div className="relative">
      <div
        className={[
          "flex gap-4 p-1 pb-4 scroll-smooth horizontal-scrollbar",
        ].join(" ")}
      >
        {CASE_STUDIES.map((t, i) => {
          ...
          return (
            <button
              ...
              className={[
                "relative cursor-pointer rounded-xl px-4 py-3 text-left transition-all",
                "shrink-0 w-[340px]",
                isActive
